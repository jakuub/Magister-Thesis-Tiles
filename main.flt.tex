...
\bibitem[Goob]{dart}
Google.
\newblock {\em {\sl Programmer’s Guide(Dart language)}}.
\newblock \hfill\break{\tt \url{https://www.dartlang.org/docs/}}.

\bibitem[Hor13]{dartlaunch}
Julian Horsey.
\newblock Google dart sdk 1.0 released to replace javascript in web
  development.
\newblock
  \url{http://www.geeky-gadgets.com/google-dart-sdk-1-0-released-to-replace-javascript-in-web-development-14-11-2013/},
  2013.
...
\bibitem[Uhr]{tiles}
Jakub Uhrik.
\newblock {\em {\sl The Tiles library source code on github.com}}.
\newblock \hfill\break{\tt \url{https://github.com/cleandart/tiles}}.

\bibitem[wika]{flexdatabinding}
Flex~SDK wiki.
\newblock {\em {\sl Two-way Data Binding - Functional and Design
  Specification}}.
\newblock \hfill\break{\tt
  \url{http://sourceforge.net/adobe/flexsdk/wiki/Two-way%20Data%20Binding/}}.

\bibitem[Wikb]{databindingwikipedia}
Wikipedia.
\newblock {\em {\sl Data binding}}.
\newblock \hfill\break{\tt \url{http://en.wikipedia.org/wiki/Data_binding}}.
