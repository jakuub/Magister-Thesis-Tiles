...
\section{Mass versus structure}\label{sec:benchmarks-mass-vs-structure}
	...
	\begin{figure}[h]
	\centering  
		\includegraphics[scale=0.4]{images/benchmarks/m_render.png}
	...
	\begin{figure}[h]
	\centering  
		\includegraphics[scale=0.8]{images/benchmarks/s_render.png}
	...
	\begin{figure}[h]
	\centering  
		\includegraphics[scale=0.45]{images/benchmarks/mvs_render.png}
...
\section{Virtual versus real DOM}\label{sec:benchmarks-clean-vs-dirty-update}
	...
	\begin{figure}[h]
	\centering  
		\includegraphics[scale=0.45]{images/benchmarks/mvs_render_vs_virtual_.png}
	...
	\begin{figure}[h]
	\centering  
		\includegraphics[scale=0.6]{images/benchmarks/s_render_all.png}
